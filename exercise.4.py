...
def list_add_element(members):
    addmember=str(input("enter the name :"))
    print(addmember)
    members.append(addmember)
    
def list_add_elements(members):
    addmember1=str(input("enter the multiple name to add :\n")).split(",")
    print(addmember1)
    members.extend(addmember1)
    
def list_remove_element(members):
    removemember=str(input("remove the name :"))
    members.remove()
...
def display_3_4_5_element(members):
    print(members[3],members[4],members[5])
